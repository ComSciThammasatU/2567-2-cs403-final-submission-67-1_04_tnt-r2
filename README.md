...
2. สร้าง folder สำหรับการใส่โปรเจค
   ...
   ผู้ใช้จึงจำเป็นต้องใช้คำสั่ง cd เพื่อไปยังโฟลเดอร์ที่มีโค้ด (ในที่นี้คือ sourececode) และจึง ใช้คำสั่ง npm init -y เพื่อเรียกใช้ library ของ node.js

   
4. จากนั้นจึงทำการ install library ที่จำเป็น
   ...
   npm install sharp
   ```
5. ไฟล์ที่ดาวน์โหลดผู้ใช้สามารถเลือกวางตามลำดับโครงสร้างไฟล์ของระบบ
