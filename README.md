...
**1. การสร้างบัญชี (ในกรณีที่ผู้ใช้ยังไม่ได้สร้างบัญชี)** 
...
**3. การสร้างโปรเจค** 
1. คลิกปุ่ม Create New Project
2. ใส่ ชื่อ และ Tag ของโปรเจคใหม่ที่จะสร้าง
3. คลิกปุ่ม Create จะแสดง Project Card ใหม่

**4. การสร้างผลเฉลย** 
1. คลิกปุ่ม Open บน Project Card ที่สร้างใหม่
2. คลิกปุ่ม Select Image
3. เลือกรูปภาพที่ต้องการ
4. คลิกปุ่ม Open
5. หากต้องการลบรูปภาพให้คลิกไอคอน กากบาท (❌) ที่มุมของภาพ
6. คลิกเมนู Labeling
7. คลิกปุ่ม Start Labeling
8. เลือกรูปภาพที่ต้องการสร้างผลเฉลย
9. คลิกปุ่ม Create Label
10. ตั้งชื่อและเลือกสีของ Label
11. คลิกปุ่ม Create
12. คลิกที่ Label ที่สร้างไว้ทางด้านขวามือ
13. สร้างผลเฉลยโดยการตีกรอบบนตำแหน่งที่ต้องการบนรูปภาพ
14. หลังจากสร้างผลเฉลยที่ต้องการทั้งหมดแล้วคลิกปุ่ม Back
15. คลิกเมนู Dataset
16. เลือกรูปแบบของไฟล์ที่ผู้ใช้ต้องการส่งออก

   16.1 Export Raw จะส่งออกเป็นไฟล์รูปภาพ
    
   16.2 Export COCO จะส่งออกไฟล์ JSON ที่แสดงข้อมูลผลเฉลยในรูปแบบ COCO
